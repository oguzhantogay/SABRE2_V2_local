function SABRE2BConFun(pn_panel,pt_title_name,fim_infor_name,pd_type_subpanel,pdn_type_text,...
...
% *** sub panel2
set(pd_coord_subpanel,'Visible','on');
set([pdn_coord_text,pdn_coordx_text,pdn_coordy_text,pdn_coordz_text],'Visible','on');
...
% *** sub panel1
set([bfm_type_text,bfm_type_name],'Visible','on')
% *** sub panel2
set([bfm_coordx_edit,bfm_coordy_edit,bfm_coordz_edit],'Visible','on');
set(bfm_clc_apply,'Visible','on');
% *** sub panel3
set([bfm_height_text,bfm_member_text],'Visible','on');
set(bfm_height_edit,'Visible','on');
% *** sub panel4
set(bfm_bc_text,'Visible','on');
set([bfm_ux_text,bfm_uy_text,bfm_uz_text],'Visible','on');
set([bfm_rx_text,bfm_ry_text,bfm_rz_text,bfm_phix_text],'Visible','on');
set([bfm_ux_buttongroup,bfm_ux_on_radiobutton,bfm_ux_off_radiobutton],'Visible','on');
set([bfm_uy_buttongroup,bfm_uy_on_radiobutton,bfm_uy_off_radiobutton],'Visible','on');
set([bfm_uz_buttongroup,bfm_uz_on_radiobutton,bfm_uz_off_radiobutton],'Visible','on');
set([bfm_rx_buttongroup,bfm_rx_on_radiobutton,bfm_rx_off_radiobutton],'Visible','on');
set([bfm_ry_buttongroup,bfm_ry_on_radiobutton,bfm_ry_off_radiobutton],'Visible','on');
set([bfm_rz_buttongroup,bfm_rz_on_radiobutton,bfm_rz_off_radiobutton],'Visible','on');
set([bfm_phix_buttongroup,bfm_phix_on_radiobutton,bfm_phix_off_radiobutton],'Visible','on');
set([bfm_ux_edit,bfm_uy_edit,bfm_uz_edit,bfm_rx_edit,...
   bfm_ry_edit,bfm_rz_edit,bfm_phix_edit],'Visible','off');
% *** sub panel5
set([bfm_apply,bfm_cancel],'Visible','on'); 
...
set(bfm_height_text,'String','Constraint Location')
% ------------------------------------------------------------------------
% -----------------------        EDIT INUPT       ------------------------
% ------------------------------------------------------------------------  
...
if ~isempty(get(gco,'Tag'))     
   if isempty(PNC)
      ...
      set(gco,'Color','c')       
      % shear center
      set(bfm_type_name,'String',num2str(RNCc(sscanf(get(gco,'Tag'),'RNCc%u'),1)))
      set(bfm_coordx_edit,'String',num2str(RNCc(sscanf(get(gco,'Tag'),'RNCc%u'),2)))
      set(bfm_coordy_edit,'String',num2str(RNCc(sscanf(get(gco,'Tag'),'RNCc%u'),3)))
      set(bfm_coordz_edit,'String',num2str(RNCc(sscanf(get(gco,'Tag'),'RNCc%u'),4))) 
      ...
      if strcmp(get(gco,'Type'),'line')
         ...
         set(bfm_coordy_edit,'String',num2str(RNCc(sscanf(get(gco,'Tag'),'RNCc%u'),3)))
         set(bfm_coordz_edit,'String',num2str(RNCc(sscanf(get(gco,'Tag'),'RNCc%u'),4))) 
         set(bfm_ux_edit,'String',num2str(PNC(sscanf(get(gco,'Tag'),'RNCc%u'),5)))
         set(bfm_uy_edit,'String',num2str(PNC(sscanf(get(gco,'Tag'),'RNCc%u'),6)))
         set(bfm_uz_edit,'String',num2str(PNC(sscanf(get(gco,'Tag'),'RNCc%u'),7)))
         set(bfm_rx_edit,'String',num2str(PNC(sscanf(get(gco,'Tag'),'RNCc%u'),8)))
         set(bfm_ry_edit,'String',num2str(PNC(sscanf(get(gco,'Tag'),'RNCc%u'),9)))
         set(bfm_rz_edit,'String',num2str(PNC(sscanf(get(gco,'Tag'),'RNCc%u'),10)))
         set(bfm_phix_edit,'String',num2str(PNC(sscanf(get(gco,'Tag'),'RNCc%u'),11)))
         if isequal(PNC(sscanf(get(gco,'Tag'),'RNCc%u'),13),2) ...
               || isequal(PNC(sscanf(get(gco,'Tag'),'RNCc%u'),13),3) ...
               || isequal(PNC(sscanf(get(gco,'Tag'),'RNCc%u'),13),4)    
            if isequal(round(Thg(sscanf(get(gco,'Tag'),'RNCc%u'),1)*10^9)/10^9,0) && isequal(round(Thg(sscanf(get(gco,'Tag'),'RNCc%u'),2)*10^9)/10^9,0) ...
                  && isequal(round(Bhg(sscanf(get(gco,'Tag'),'RNCc%u'),1)*10^9)/10^9,0) && isequal(round(Bhg(sscanf(get(gco,'Tag'),'RNCc%u'),2)*10^9)/10^9,0)
               set(bfm_height_edit,'Value',1)
            else
               set(bfm_height_edit,'Value',PNC(sscanf(get(gco,'Tag'),'RNCc%u'),13))
            end
         else
            set(bfm_height_edit,'Value',1)
         end
      
         if isequal(round(PNC(sscanf(get(gco,'Tag'),'RNCc%u'),5)) ,1)
            set(bfm_ux_on_radiobutton,'value',0)
            set(bfm_ux_off_radiobutton,'value',1)
         elseif isequal(round(PNC(sscanf(get(gco,'Tag'),'RNCc%u'),5)) ,0)
            set(bfm_ux_on_radiobutton,'value',1)
            set(bfm_ux_off_radiobutton,'value',0)         
         end
 
         if isequal(round(PNC(sscanf(get(gco,'Tag'),'RNCc%u'),6)) ,1)
            set(bfm_uy_on_radiobutton,'value',0)
            set(bfm_uy_off_radiobutton,'value',1)
         elseif isequal(round(PNC(sscanf(get(gco,'Tag'),'RNCc%u'),6)) ,0)
            set(bfm_uy_on_radiobutton,'value',1)
            set(bfm_uy_off_radiobutton,'value',0)         
         end

         if isequal(round(PNC(sscanf(get(gco,'Tag'),'RNCc%u'),7)) ,1)
            set(bfm_uz_on_radiobutton,'value',0)
            set(bfm_uz_off_radiobutton,'value',1)
         elseif isequal(round(PNC(sscanf(get(gco,'Tag'),'RNCc%u'),7)) ,0)
            set(bfm_uz_on_radiobutton,'value',1)
            set(bfm_uz_off_radiobutton,'value',0)         
         end      
      
         if isequal(round(PNC(sscanf(get(gco,'Tag'),'RNCc%u'),8)) ,1)
            set(bfm_rx_on_radiobutton,'value',0)
            set(bfm_rx_off_radiobutton,'value',1)
         elseif isequal(round(PNC(sscanf(get(gco,'Tag'),'RNCc%u'),8)) ,0)
            set(bfm_rx_on_radiobutton,'value',1)
            set(bfm_rx_off_radiobutton,'value',0)         
         end
      
         if isequal(round(PNC(sscanf(get(gco,'Tag'),'RNCc%u'),9)) ,1)
            set(bfm_ry_on_radiobutton,'value',0)
            set(bfm_ry_off_radiobutton,'value',1)
         elseif isequal(round(PNC(sscanf(get(gco,'Tag'),'RNCc%u'),9)) ,0)
            set(bfm_ry_on_radiobutton,'value',1)
            set(bfm_ry_off_radiobutton,'value',0)         
         end
      
         if isequal(round(PNC(sscanf(get(gco,'Tag'),'RNCc%u'),10)) ,1)
            set(bfm_rz_on_radiobutton,'value',0)
            set(bfm_rz_off_radiobutton,'value',1)
         elseif isequal(round(PNC(sscanf(get(gco,'Tag'),'RNCc%u'),10)) ,0)
            set(bfm_rz_on_radiobutton,'value',1)
            set(bfm_rz_off_radiobutton,'value',0)         
         end      
      
         if isequal(round(PNC(sscanf(get(gco,'Tag'),'RNCc%u'),11)) ,1)
            set(bfm_phix_on_radiobutton,'value',0)
            set(bfm_phix_off_radiobutton,'value',1)
         elseif isequal(round(PNC(sscanf(get(gco,'Tag'),'RNCc%u'),11)) ,0)
            set(bfm_phix_on_radiobutton,'value',1)
            set(bfm_phix_off_radiobutton,'value',0)         
         end        
      end % line
   end
end   
