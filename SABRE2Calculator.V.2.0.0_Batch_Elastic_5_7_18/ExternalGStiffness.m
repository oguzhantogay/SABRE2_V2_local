...
Kext1=zeros(14,14); Kext2=zeros(14,14);
...
Kext2(2,2) = P/L;
Kext2(2,3) = Vz*Zetaavg/L;                                                  %Zetaavg = yavg1/yavg2
Kext2(2,4) = Vz*Eta1/2;                                                     %Eta1 = e2p2/yavg2
Kext2(2,5) =-Vz*Zeta1/2;                                                    %Zeta1 = e2p1/yavg2
Kext2(2,9) =-P/L;
Kext2(2,10)=-Vz*Zetaavg/L;                 
Kext2(2,11)= Vz*Eta2/2;                                                     %Eta2 = e2q2/yavg2
Kext2(2,12)=-Vz*Zeta2/2;                                                    %Zeta2 = e2q1/yavg2
...
Kext2(9,12)= Vz*Zeta2/2;                                                    %%% different typo (minus sign)
...
Kext2(10,12)=-Vy*Zeta2/2;                                                   %%% different typo (minus sign)
...
Kext2(13,3) = (My2*Zetaavg-T)/L;  %%%                                          %%% same
Kext2(13,4) = My2*Eta1/2;
Kext2(13,5) =-My2*Zeta1/2;
Kext2(13,10)= (-My2*Zetaavg+T)/L;  %%%                                         %%% same
