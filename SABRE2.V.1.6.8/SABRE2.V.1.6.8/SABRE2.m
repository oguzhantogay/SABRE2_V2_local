...
inf_title_name = uicontrol('Style','text','String','SABRE2 v1.6','Tag','ITitle',...  
...
function file_open_menu_Callback(hObject, eventdata)
   ...
   if isequal(strcmp(get(vstm,'Checked'),'on'),1) % white background   
      [RNCc,Nshe1,Nshe2,DUP1,DUP2,NCc,Bhe1,Bhe2,The1,The2,SGhe1,SGhe2,Mhe1,Mhe2,Bhg,Thg,CSg,BNC1,BNC2,FEL,error]=SABRE2LBCODEW(JNodevalue,...
...
function pdb_apply_pushbutton_Callback(hObject, eventdata)
   clc
   x = 'General apply button of add nodes menu \n';
...
function pdmi_apply_pushbutton_Callback(hObject, eventdata)  
   ...
   if strcmp(selection,'No')
      ...
      % Drawing Nodal white points & generate NC
   if isequal(strcmp(get(vstm,'Checked'),'on'),1) % white background   
      [RNCc,Nshe1,Nshe2,DUP1,DUP2,NCc,Bhe1,Bhe2,The1,The2,SGhe1,SGhe2,Mhe1,Mhe2,Bhg,Thg,CSg,BNC1,BNC2,FEL,error,LNC,LNC1,LNC2,LUEC,PNC,PNC1,PNC2,BNC]=SABRE2MLCODEW(JNodevalue,...
         Massemble,JNodevalue_i,JNodevalue_j,Rval,BNodevalue,SNodevalue,...
         RNCc,Nshe1,Nshe2,DUP1,DUP2,NCc,LNC,LNC1,LNC2,LUEC,PNC,PNC1,PNC2,BNC,BNC1,BNC2,FEL,Bhe1,Bhe2,The1,The2,SGhe1,SGhe2,Mhe1,Mhe2,Bhg,Thg,CSg,pdmi_name,pdmi_type_edit,LabType,pt_title_name,axesm,vstm);    
   elseif isequal(strcmp(get(vstm,'Checked'),'on'),0) % black background       
