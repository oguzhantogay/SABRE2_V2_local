function SABRE2AssiFun(pn_panel,pt_title_name,fim_infor_name,pd_type_subpanel,pdn_type_text,...
...
% *** sub panel1
set(pam_type_text,'Visible','on')
% *** sub panel2
set([pam_segmentn_text,pamse_assign_text],'Visible','on');
set([pam_segment_edit,pamse_assign_edit,pam_all],'Visible','on'); 
% *** sub panel3
set([pam_assign_text,pamen_assign_text,pame_assign_text,pamg_assign_text,pamrho_assign_text],'Visible','on');
set([pamen_assign_edit,pame_assign_edit,pamg_assign_edit,pamrho_assign_edit],'Visible','on'); 
set([pamfy_assign_text,pamfyfi_assign_text,pamfyw_assign_text,pamfyfo_assign_text],'Visible','off');
set([pamfy_assign_edit,pamfyfi_assign_edit,pamfyw_assign_edit,pamfyfo_assign_edit],'Visible','off');
% *** sub panel4
set([pam_apply,pam_cancel],'Visible','on'); 
