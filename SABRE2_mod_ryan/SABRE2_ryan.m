clc; clear
%% -------------edit the directory--------------------------------------
inpath='C:\Users\rslein3\SABRE2-V3\SABRE2_mod_ryan\input\';
...
[RNCc,Nshe1,Nshe2,DUP1,DUP2,NCc,Bhe1,Bhe2,The1,The2,SGhe1,SGhe2,Mhe1,Mhe2,Bhg,Thg,CSg,BNC1,BNC2,FEL]=SABRE2LBCODE_ryan(JNodevalue,...
 Massemble,JNodevalue_i,JNodevalue_j,Rval,BNodevalue,SNodevalue,...
 RNCc,Nshe1,Nshe2,DUP1,DUP2,NCc,BNC1,BNC2,FEL);    
% if ~isempty(AnalP)
...
ap_AISC_buttongroup='AISC_on'; %provision year
ap_cv_buttongroup='cv_off'; %bracketing algorithm
ap_sw_buttongroup='sw off'; %self weight flag
ap_jval_buttongroup='jval_off'; %J=0 for slender webs
