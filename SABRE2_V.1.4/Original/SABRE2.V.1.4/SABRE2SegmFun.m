function SABRE2SegmFun(pn_panel,pt_title_name,fim_infor_name,pd_type_subpanel,pdn_type_text,...
...
set([pde_tft_text,pde_dw_text,pde_tw_text,pde_fil_text],'Visible','on');
...
% *** sub panel1
set([pdb_member_text,pdb_type_text],'Visible','on')
set([pdb_member_name,pdb_type_name],'Visible','on')
% *** sub panel2
set(pdb_length_text,'Visible','on');
set([pdb_coordx_edit,pdb_coordy_edit,pdb_coordz_edit,pdb_length_edit,pdb_length_set],'Visible','on');
% *** sub panel3
set([pdb_wsection_edit,pdb_set],'Visible','on');
set([pdb_step_text,pdb_step_edit,pdstep_subpanel],'Visible','on');
% *** sub panel4
set([pdb_bfb_edit,pdb_tfb_edit,pdb_bft_edit,pdb_tft_edit,pdb_dw_edit,pdb_tw_edit],'Visible','on');
set(pdb_fil_edit,'Visible','on');
% *** sub panel5
set([pdb_apply,pdb_cancel],'Visible','on'); 
...
% strcmp(sscanf(get(gco,'Tag'),'%[jn]'),'jn')
% ************* If click a Member or Segments, set the data automatically. 
if strcmp(get(gco,'type'),'line') % Additional Nodal Point Click
   if strcmp(sscanf(get(gco,'Tag'),'%[M]'),'M')      
      t=sscanf(get(gco,'Tag'),'M%ub%u');
      mnum = t(1,1);
      nbnode = t(2,1);
      ...
      set(gco,'Color','g')
      set(pdb_member_name,'String',num2str(mnum));
      set(pdb_type_name,'String',num2str(nbnode));
      set(pdb_coordx_edit,'String',num2str(BNodevalue(mnum,nbnode,3)));
      set(pdb_coordy_edit,'String',num2str(BNodevalue(mnum,nbnode,4)));
      set(pdb_coordz_edit,'String',num2str(BNodevalue(mnum,nbnode,5)));
      set(pdb_bfb_edit,'String',num2str(BNodevalue(mnum,nbnode,6)));
      set(pdb_tfb_edit,'String',num2str(BNodevalue(mnum,nbnode,7)));
      set(pdb_bft_edit,'String',num2str(BNodevalue(mnum,nbnode,8)));
      set(pdb_tft_edit,'String',num2str(BNodevalue(mnum,nbnode,9)));
      set(pdb_dw_edit,'String',num2str(BNodevalue(mnum,nbnode,10)));
      set(pdb_tw_edit,'String',num2str(BNodevalue(mnum,nbnode,11)));
      set(pdb_fil_edit,'String',num2str(BNodevalue(mnum,nbnode,14)));
      set(pdb_length_edit,'String',num2str(BNodevalue(mnum,nbnode,16))); 
   end
elseif strcmp(get(gco,'type'),'text') % Member Click   
   if strcmp(sscanf(get(gco,'String'),'%[M]'),'M')
      ...
      set(pdb_member_name,'String',num2str(mnum));
      set(pdb_type_name,'String',num2str(nextBnum));
      set(pdb_coordx_edit,'String','');
      set(pdb_coordy_edit,'String','');
      set(pdb_coordz_edit,'String',''); 
      set(pdb_length_edit,'String','');
      set(pdb_bfb_edit,'String',num2str(JNodevalue_i(mnum,6)));
      set(pdb_tfb_edit,'String',num2str(JNodevalue_i(mnum,7))); 
      set(pdb_bft_edit,'String',num2str(JNodevalue_i(mnum,8)));
      set(pdb_tft_edit,'String',num2str(JNodevalue_i(mnum,9))); 
      set(pdb_dw_edit,'String',num2str(JNodevalue_i(mnum,10)));
      set(pdb_tw_edit,'String',num2str(JNodevalue_i(mnum,11)));
      set(pdb_fil_edit,'String',num2str(JNodevalue_i(mnum,14)));
   end
end    
...
set(pdb_wsection_edit,'String',num2str(TYPE))
