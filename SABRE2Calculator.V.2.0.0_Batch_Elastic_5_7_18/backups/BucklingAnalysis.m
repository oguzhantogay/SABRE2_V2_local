function [gamma] = BucklingAnalysis(...
...
Dcb1,Dcb2,hct1,hct2,hcb1,hcb2,CSD1,CSD2,Afillet1,Afillet2]=deal(zeros...
...
for i=1:nnodes
    ...
    Afillet1(i,1)=Geometry_data(9,i);                                       % Area of fillet weld start
    Afillet2(i,1)=Geometry_data(9,i);                                       % Area of fillet weld end
...
if ~isequal(Dg1(Member_data(2,i),1),Dg2(Member_data(2,i),1))                % Calculate each element cross section if linearly tapered
bfbe=bfb1(Member_data(2,i),1)*(1-xe/L)+bfb2(Member_data(3,i),1)*xe/L;
bfte=bft1(Member_data(2,i),1)*(1-xe/L)+bft2(Member_data(3,i),1)*xe/L;        
tfbe=tfb1(Member_data(2,i),1)*(1-xe/L)+tfb2(Member_data(3,i),1)*xe/L;
tfte=tft1(Member_data(2,i),1)*(1-xe/L)+tft2(Member_data(3,i),1)*xe/L;
De=Dg1(Member_data(2,i),1)*(1-xe/L)+Dg2(Member_data(3,i),1)*xe/L;
twe=tw1(Member_data(2,i),1)*(1-xe/L)+tw2(Member_data(3,i),1)*xe/L;
Afillete=Afillet1(Member_data(2,i),1)*(1-xe/L)+Afillet2(Member_data(3,i),1)*xe/L;
hte=ht1(Member_data(2,i),1)*(1-xe/L)+ht2(Member_data(3,i),1)*xe/L;
hbe=hb1(Member_data(2,i),1)*(1-xe/L)+hb2(Member_data(3,i),1)*xe/L;
yse=Dmid1(Member_data(2,i),1)*(1-xe/L)+Dmid2(Member_data(3,i),1)*xe/L;
else                                                                        % Use nontapered geometry
bfbe=bfb1(Member_data(2,i),1);
bfte=bft1(Member_data(2,i),1);
tfbe=tfb1(Member_data(2,i),1);
tfte=tft1(Member_data(2,i),1);
De=Dg1(Member_data(2,i),1);
twe=tw1(Member_data(2,i),1);
Afillete=Afillet1(Member_data(2,i),1);
hte=ht1(Member_data(2,i),1);
hbe=hb1(Member_data(2,i),1);
yse=Dmid1(Member_data(2,i),1);
end

hstp = ( hst2(i,1)-hst1(Member_data(2,i),1) )/DX(i,1);
hsbp = ( hsb2(i,1)-hsb1(Member_data(2,i),1) )/DX(i,1);
ysp  = ( ys2(i,1) -ys1(Member_data(2,i),1)  )/DX(i,1);
bftp = ( bft2(i,1)-bft1(Member_data(2,i),1) )/DX(i,1);
bfbp = ( bfb2(i,1)-bfb1(Member_data(2,i),1) )/DX(i,1);
