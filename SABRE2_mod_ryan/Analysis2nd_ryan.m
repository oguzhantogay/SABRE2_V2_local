function [AS,Funew,Qintf,QintfE,Qintg,Qint1,Qint2,MI,Sincre] = Analysis2nd_ryan(Massemble,Rval,...
   JNodevalue_i,JNodevalue_j,SNodevalue,RNCc,Nshe1,Nshe2,DUP1,DUP2,LNC,LNC1,LNC2,...
   LUEC,PNC,PNC1,PNC2,BNC,BNC1,BNC2,FEL,tolerance,ninc,niter,lambda,ap_sw_buttongroup,ap_da_buttongroup)
