function SABRE2JointModel(JNodevalue,Massemble,JNodevalue_i,JNodevalue_j,...
   Rval,BNodevalue,axesm,vstm)
% Developed by Woo Yong Jeong.
% Date : 07/01/2013.
% ------------------------------------------------------------------------
% ------------   3D Model generator for Joint Node          --------------
% ------------------------------------------------------------------------
...
if isempty(Massemble) % Only Joints
   ...
   for i = 1:njnode
      plot3(axesm,JNodevalue(i,2),-JNodevalue(i,4),JNodevalue(i,3),...
         'Marker','.','Color','r','MarkerSize',14,'Tag',['jn',num2str(i)],'HitTest','on');
      hold on;
   end
...
%          switch Rval(i,2) 
%             case 1
%                j1=[0;-(Fhsb1+Fhst1)*1.1/2;0];j1 = Rz*j1;
%                j2=[0;+(Fhsb1+Fhst1)*1.1/2;0];j2 = Rz*j2;
% 
...
%             case 3
%                j1=[0;0;0];j1 = Rz*j1;
%                j2=[0;+(Fhsb1+Fhst1)*1.1;0];j2 = Rz*j2;
% 
%                j3=[0;0;0];j3 = Rz*j3;
%                j4=[0;+(Fhsb2+Fhst2)*1.1;0];j4 = Rz*j4;                  
%             case 2
%                j1=[0;-(Fhsb1+Fhst1)*1.1;0];j1 = Rz*j1;
%                j2=[0;+0;0];j2 = Rz*j2;
% 
