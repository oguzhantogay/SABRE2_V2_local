function SABRE2ModelP(JNodevalue,Massemble,JNodevalue_i,JNodevalue_j,...
   ...
   if isequal(strcmp(get(vstm,'Checked'),'on'),1) % white background
      ...
      for i = 1:njnode
         text(JNodevalue(i,2),-JNodevalue(i,4),JNodevalue(i,3),['jn',num2str(i)],...
            ...
            'FontSize',9,'HitTest','off','Color','k','Tag','Text');
         hold on ;
      end  
      ...
      for i = 1:njnode
         text(JNodevalue(i,2),-JNodevalue(i,4),JNodevalue(i,3),['jn',num2str(i)],...
            'VerticalAlignment','bottom','HorizontalAlignment','right',...
            'FontSize',9,'HitTest','off','Color','w','Tag','Text');
         hold on ;
      end 
   end
...
%       hold on;
      ...
      if isequal(strcmp(get(vstm,'Checked'),'on'),1) % white background  
         otf = surf(axesm,Xwtf,Zwtf,Ywtf,'FaceColor',[0.6 0.6 0.6],'Clipping','off', ...
            'EdgeColor',[0.6 0.6 0.6],'HitTest','off','Tag',['OTFB',num2str(i)]); hold on
         oweb = surf(axesm,Xwweb,Zwweb,Ywweb,'FaceColor',[0.7 0.7 0.7],'Clipping','off',...
            'EdgeColor',[0.6 0.6 0.6],'HitTest','off','Tag',['OWEBB',num2str(i)]); hold on
         obf = surf(axesm,Xwbf,Zwbf,Ywbf,'FaceColor',[0.6 0.6 0.6],'Clipping','off',...
            'EdgeColor',[0.6 0.6 0.6],'HitTest','off','Tag',['OBFB',num2str(i)]); hold on         
         % Level of transparency.
         alpha([otf,oweb,obf],0.5)
       elseif isequal(strcmp(get(vstm,'Checked'),'on'),0) % black background   
         otf = surf(axesm,Xwtf,Zwtf,Ywtf,'FaceColor',[0.7 0.7 0.7],'Clipping','off', ...
            'EdgeColor',[0.3 0.3 0.3],'HitTest','off','Tag',['OTFB',num2str(i)]); hold on
         oweb = surf(axesm,Xwweb,Zwweb,Ywweb,'FaceColor',[0.8 0.8 0.8],'Clipping','off',...
            'EdgeColor',[0.3 0.3 0.3],'HitTest','off','Tag',['OWEBB',num2str(i)]); hold on
         obf = surf(axesm,Xwbf,Zwbf,Ywbf,'FaceColor',[0.7 0.7 0.7],'Clipping','off',...
            'EdgeColor',[0.3 0.3 0.3],'HitTest','off','Tag',['OBFB',num2str(i)]); hold on       
         % Level of transparency.
         alpha([otf,oweb,obf],0.5) 
      end
   end  % for end  
...
% ----------------------------------------------------------------------
   ...
   if isequal(strcmp(get(vstm,'Checked'),'on'),1) % white background
      ...
      for i = 1:njnode
         text(JNodevalue(i,2),-JNodevalue(i,4),JNodevalue(i,3),['jn',num2str(i)],...
            'VerticalAlignment','bottom','HorizontalAlignment','right',...
            'FontSize',9,'HitTest','off','Color','k','Tag','JN');
         hold on ;
      end 
   elseif isequal(strcmp(get(vstm,'Checked'),'on'),0) % black background
      % Texting Nodal Points
      for i = 1:njnode
         text(JNodevalue(i,2),-JNodevalue(i,4),JNodevalue(i,3),['jn',num2str(i)],...
            'VerticalAlignment','bottom','HorizontalAlignment','right',...
            'FontSize',9,'HitTest','off','Color','w','Tag','JN');
         hold on ;
      end 
   end   
   % ********************************************** Plot Joint Node E 
