function [AR,Funew,Qintf,QintfE,Qintg,Qint1,Qint2,MI] = Analysis1st(Massemble,Rval,JNodevalue_i,JNodevalue_j,SNodevalue,...
...
if isequal(Bflag,1)
   delete(wh)
   set(pt_title_name,'String','1st Order Elastic Analysis did not finish. Please try to check loads and boundry conditions.')
