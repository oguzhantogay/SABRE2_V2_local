function SABRE2GroundFun(pn_panel,pt_title_name,fim_infor_name,pd_type_subpanel,pdn_type_text,...
...
set([bfm_rx_text,bfm_ry_text,bfm_rz_text],'Visible','on');
set(bfm_phix_text,'Visible','on');
...
% *** sub panel1
set(bgm_type_name,'Visible','on')
% *** sub panel2
set([bgm_coordx_edit,bgm_coordy_edit,bgm_coordz_edit],'Visible','on');
set(bgm_clc_apply,'Visible','on');
% *** sub panel3
set(bgm_height_edit,'Visible','on');
% *** sub panel4
set(bgm_bc_text,'Visible','on');
set([bgm_ux_edit,bgm_uy_edit,bgm_uz_edit,bgm_rx_edit,bgm_ry_edit,bgm_rz_edit,bgm_phix_edit],'Visible','on');
% *** sub panel5
set([bgm_apply,bgm_cancel],'Visible','on');
...
set(bfm_height_text,'String','Spring Location')
% ------------------------------------------------------------------------
% -----------------------        EDIT INUPT       ------------------------
% ------------------------------------------------------------------------  
...
if ~isempty(get(gco,'Tag'))     
   if isempty(BNC)
      ...
      set(gco,'Color','c')      
      % shear center
      set(bgm_type_name,'String',num2str(RNCc(sscanf(get(gco,'Tag'),'RNCc%u'),1)))
      set(bgm_coordx_edit,'String',num2str(RNCc(sscanf(get(gco,'Tag'),'RNCc%u'),2)))
      set(bgm_coordy_edit,'String',num2str(RNCc(sscanf(get(gco,'Tag'),'RNCc%u'),3)))
      set(bgm_coordz_edit,'String',num2str(RNCc(sscanf(get(gco,'Tag'),'RNCc%u'),4))) 
      set(bgm_ux_edit,'String','0')
      set(bgm_uy_edit,'String','0')
      set(bgm_uz_edit,'String','0') 
      set(bgm_rx_edit,'String','0')
      set(bgm_ry_edit,'String','0')
      set(bgm_rz_edit,'String','0')
      set(bgm_phix_edit,'String','0')
      ...
      if strcmp(get(gco,'Type'),'line')
         ...
         set(bgm_coordy_edit,'String',num2str(RNCc(sscanf(get(gco,'Tag'),'RNCc%u'),3)))
         set(bgm_coordz_edit,'String',num2str(RNCc(sscanf(get(gco,'Tag'),'RNCc%u'),4))) 
         set(bgm_ux_edit,'String',num2str(BNC(sscanf(get(gco,'Tag'),'RNCc%u'),5)))
         set(bgm_uy_edit,'String',num2str(BNC(sscanf(get(gco,'Tag'),'RNCc%u'),6)))
         set(bgm_uz_edit,'String',num2str(BNC(sscanf(get(gco,'Tag'),'RNCc%u'),7)))
         set(bgm_rx_edit,'String',num2str(BNC(sscanf(get(gco,'Tag'),'RNCc%u'),8)))
         set(bgm_ry_edit,'String',num2str(BNC(sscanf(get(gco,'Tag'),'RNCc%u'),9)))
         set(bgm_rz_edit,'String',num2str(BNC(sscanf(get(gco,'Tag'),'RNCc%u'),10)))
         set(bgm_phix_edit,'String',num2str(BNC(sscanf(get(gco,'Tag'),'RNCc%u'),11)))
         if isequal(BNC(sscanf(get(gco,'Tag'),'RNCc%u'),13),2) ...
               || isequal(BNC(sscanf(get(gco,'Tag'),'RNCc%u'),13),3)
            if isequal(round(Thg(sscanf(get(gco,'Tag'),'RNCc%u'),1)*10^9)/10^9,0) && isequal(round(Thg(sscanf(get(gco,'Tag'),'RNCc%u'),2)*10^9)/10^9,0) ...
               ...
               set(bgm_height_edit,'Value',1)
            else
               set(bgm_height_edit,'Value',BNC(sscanf(get(gco,'Tag'),'RNCc%u'),13))
            end
         else
            set(bgm_height_edit,'Value',1)
         end      
