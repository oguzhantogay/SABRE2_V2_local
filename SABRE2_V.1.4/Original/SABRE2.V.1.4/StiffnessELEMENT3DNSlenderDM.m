function [Kt,Kgg,Qino,Kh2,Qin_into]=StiffnessELEMENT3DNSlenderDM(bfb,tfb,bft,tft,Dg,yc,ht,hb,Dt,Db,hst,... 
    hsb,ys,tw,Afillet,L,E,G,fillet,hstp,hsbp,ysp,bftp,bfbp,...
    theta1x,theta1z,theta1y,theta2x,theta2z,theta2y,theta1xp,theta2xp,qno,FEL,slender,ap_da_buttongroup,taub)
