function SABRE2AELFun(pn_panel,pt_title_name,fim_infor_name,ptable_type_subpanel,...
...
set(recba_tau_diagram,'String','   Undeformed Geometry |   Buckling Mode + Undeformed Geom. |   Buckling Mode Only |   Axial |   Moment Z ')
