function SABRE2REleForFun(pn_panel,pt_title_name,fim_infor_name,pd_type_subpanel,pdn_type_text,...
...
% *** sub panel1
set([ref_type_text,ref_type_edit],'Visible','on')
% *** sub pane2
set([re_force_text,refx_force_text,refy_force_text,...
   refz_force_text,ret_force_text,remy_force_text,remz_force_text,rebi_force_text],'Visible','on');
set([refx_force_edit,refy_force_edit,refz_force_edit,...
   remx_force_edit,remy_force_edit,remz_force_edit,rebi_force_edit],'Visible','on');
% *** sub pane3
set([re_forcebar_slider,re_forcebar_edit],'Visible','on');
% *** sub pane4
set([ref_apply,ref_cancel],'Visible','on');
...
if strcmp(get(gco,'type'),'line') 
   if strcmp(sscanf(get(gco,'Tag'),'%[ShearP]'),'ShearP')
      ...
      shearstiffness=BNC1(sscanf(get(gco,'Tag'),'ShearP%u'),8);
      joint1=BNC1(sscanf(get(gco,'Tag'),'ShearP%u'),2);
      joint2=BNC2(sscanf(get(gco,'Tag'),'ShearP%u'),2);
      IncreL = get(ref_cancel,'Value');
      ShearPanelForce=abs(Funew(joint1,3,IncreL)- Funew(joint2,3,IncreL))*shearstiffness;

      % ---------------------------------------------------------------------
      % ----------            Plot Shear Panel Force     --------------------
      % --------------------------------------------------------------------- 
      xa =max(RNCc(:,9))/2;delete(findobj('Tag','SHText'));
      ...
      if isempty(RNCc) || isempty(BNC1)
         ...
         if isequal(abs(BNC1(sbcnum,2)-BNC2(sbcnum,2)),1)
            if ~isequal(BNC1(sbcnum,8),0) 
               if isequal(BNC1(sbcnum,9),1) || isequal(BNC1(sbcnum,9),0) % Top flange                    
                  if isequal(strcmp(get(vstm,'Checked'),'on'),1) % white background
                     text(( (BNC1(sbcnum,3)+The1(BNC1(sbcnum,11),1)+BNC2(sbcnum,3)+The2(BNC2(sbcnum,11),1))/2 ),...
                        ( (BNC1(sbcnum,5)+The1(BNC1(sbcnum,11),3)+BNC2(sbcnum,5)+The2(BNC2(sbcnum,11),3))/2 + xa*0.5),...
                        ( (BNC1(sbcnum,4)+The1(BNC1(sbcnum,11),2)+BNC2(sbcnum,4)+The2(BNC2(sbcnum,11),2))/2 ),num2str(ShearPanelForce),...
                        'VerticalAlignment','bottom','HorizontalAlignment','right',...
                        'FontSize',9,'HitTest','off',num2str,'k','Tag','SHText');
                     hold on ;
                  elseif isequal(strcmp(get(vstm,'Checked'),'on'),0) % black background
                     text(( (BNC1(sbcnum,3)+The1(BNC1(sbcnum,11),1)+BNC2(sbcnum,3)+The2(BNC2(sbcnum,11),1))/2 ),...
                        ...
                        ( (BNC1(sbcnum,4)+The1(BNC1(sbcnum,11),2)+BNC2(sbcnum,4)+The2(BNC2(sbcnum,11),2))/2 ),num2str(ShearPanelForce),...
                        'VerticalAlignment','bottom','HorizontalAlignment','right',...
                        'FontSize',9,'HitTest','off',num2str,'w','Tag','SHText');
                     hold on ;
                  end 

               elseif isequal(BNC1(sbcnum,9),2)
                  if isequal(strcmp(get(vstm,'Checked'),'on'),1) % white background
                     text(( (BNC1(sbcnum,3)+BNC2(sbcnum,3))/2 ),( (BNC1(sbcnum,5)+BNC2(sbcnum,5))/2 + xa*0.5),...
                        ( (BNC1(sbcnum,4)+BNC2(sbcnum,4))/2 ),num2str(ShearPanelForce),...
                        'VerticalAlignment','bottom','HorizontalAlignment','right',...
                        'FontSize',9,'HitTest','off','Color','k','Tag','SHText');        
                     hold on ;  
                  elseif isequal(strcmp(get(vstm,'Checked'),'on'),0) % black background
                     text(( (BNC1(sbcnum,3)+BNC2(sbcnum,3))/2 ),( (BNC1(sbcnum,5)+BNC2(sbcnum,5))/2 + xa*0.5),...
                        ( (BNC1(sbcnum,4)+BNC2(sbcnum,4))/2 ),num2str(ShearPanelForce),...
                        'VerticalAlignment','bottom','HorizontalAlignment','right',...
                        'FontSize',9,'HitTest','off','Color','w','Tag','SHText');        
                     hold on ;  
                  end                      

               elseif isequal(BNC1(sbcnum,9),3) % Bottom flange  
                  if isequal(strcmp(get(vstm,'Checked'),'on'),1) % white background
                     text(( (BNC1(sbcnum,3)+Bhe1(BNC1(sbcnum,11),1)+BNC2(sbcnum,3)+Bhe2(BNC2(sbcnum,11),1))/2 ),...
                        ( (BNC1(sbcnum,5)+Bhe1(BNC1(sbcnum,11),3)+BNC2(sbcnum,5)+Bhe2(BNC2(sbcnum,11),3))/2 + xa*0.5),...
                        ( (BNC1(sbcnum,4)+Bhe1(BNC1(sbcnum,11),2)+BNC2(sbcnum,4)+Bhe2(BNC2(sbcnum,11),2))/2 ),num2str(ShearPanelForce),...
                        'VerticalAlignment','bottom','HorizontalAlignment','right',...
                        'FontSize',9,'HitTest','off','Color','k','Tag','SHText');
                     hold on ; 
                  elseif isequal(strcmp(get(vstm,'Checked'),'on'),0) % black background
         ...
         elseif abs(BNC1(sbcnum,2)-BNC2(sbcnum,2)) > 1
            if ~isequal(BNC1(sbcnum,8),0)                 
               if isequal(BNC1(sbcnum,9),1) || isequal(BNC1(sbcnum,9),0) % Top flange
                  if isequal(strcmp(get(vstm,'Checked'),'on'),1) % white background
                     text(( (BNC1(sbcnum,3)+The1(BNC1(sbcnum,11),1)+BNC2(sbcnum,3)+The2(BNC2(sbcnum,11),1))/2 ),...
                        ( (BNC1(sbcnum,5)+The1(BNC1(sbcnum,11),3)+BNC2(sbcnum,5)+The2(BNC2(sbcnum,11),3))/2 + xa),...
                        ( (BNC1(sbcnum,4)+The1(BNC1(sbcnum,11),2)+BNC2(sbcnum,4)+The2(BNC2(sbcnum,11),2))/2 ),num2str(ShearPanelForce),...
                        'VerticalAlignment','bottom','HorizontalAlignment','right',...
                        'FontSize',9,'HitTest','off','Color','k','Tag','SHText');
                     hold on ; 
               ...
               elseif isequal(BNC1(sbcnum,9),2) 
                  if isequal(strcmp(get(vstm,'Checked'),'on'),1) % white background
                     text(( (BNC1(sbcnum,3)+BNC2(sbcnum,3))/2 ),( (BNC1(sbcnum,5)+BNC2(sbcnum,5))/2 + xa),...
                        ( (BNC1(sbcnum,4)+BNC2(sbcnum,4))/2 ),...
                        'VerticalAlignment','bottom','HorizontalAlignment','right',...
                        'FontSize',9,'HitTest','off','Color','k','Tag','SHText');
                     hold on ; 
                  elseif isequal(strcmp(get(vstm,'Checked'),'on'),0) % black background
               ...
               elseif isequal(BNC1(sbcnum,9),3) % Bottom flange   
                  if isequal(strcmp(get(vstm,'Checked'),'on'),1) % white background
                     text(( (BNC1(sbcnum,3)+Bhe1(BNC1(sbcnum,11),1)+BNC2(sbcnum,3)+Bhe2(BNC2(sbcnum,11),1))/2 ),...
                        ( (BNC1(sbcnum,5)+Bhe1(BNC1(sbcnum,11),3)+BNC2(sbcnum,5)+Bhe2(BNC2(sbcnum,11),3))/2 + xa),...
                        ( (BNC1(sbcnum,4)+Bhe1(BNC1(sbcnum,11),2)+BNC2(sbcnum,4)+Bhe2(BNC2(sbcnum,11),2))/2 ),num2str(ShearPanelForce),...
                        'VerticalAlignment','bottom','HorizontalAlignment','right',...
                        'FontSize',9,'HitTest','off','Color','k','Tag','SHText');
                        hold on ; 
...
%----------------- end
set(findobj('Tag','EF'),'Visible','on')
% If click Element text, set the data automatically.
if strcmp(get(gco,'Tag'),'EF')
   if isequal(strcmp(get(vstm,'Checked'),'on'),1) % white background
...
if strcmp(get(gco,'type'),'uicontrol') || strcmp(get(gco,'type'),'uipanel')
  ...
  set(ref_type_edit,'String','')
  set(refx_force_edit,'String','')
  set(refy_force_edit,'String','')
  set(refz_force_edit,'String','')
  set(remx_force_edit,'String','')
  set(remy_force_edit,'String','') 
  set(remz_force_edit,'String','')
  set(rebi_force_edit,'String','')
end

% If click white dots, set the data automatically.
if strcmp(get(gco,'Tag'),'EF')
  set(ref_type_edit,'String',num2str(sscanf(get(gco,'String'),'E%u'))) 
  set(re_forcebar_slider,'Value',0);
  incre = get(ref_cancel,'Value');   
  set(re_forcebar_edit,'String',[num2str(round(get(re_forcebar_slider,'Value'))/100),'L']);  
   Fsize1=get(remz_force_edit,'FontSize');
   set(re_forcebar_edit,'FontSize',Fsize1)  
   if ~isempty(Qintf)
...
if isequal(AR,1)
   ...
   set(ref_apply,'String','Increments')
...
set(ref_cancel,'String',num2str(Inpopnum')) 
