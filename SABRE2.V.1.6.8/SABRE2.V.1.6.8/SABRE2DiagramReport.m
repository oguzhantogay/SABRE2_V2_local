function  SABRE2DiagramReport(JNodevalue,Massemble,SNodevalue,RNCc,NCc,...
   Nshe1,Nshe2,DUP1,DUP2,Funew,Qintf,tau,Rpg,Rpc,Rpt,Rh,Myc,Myt,My,Jval,Phi_Mmax,Phi_Py,UC,PrPeL,PrPeL2nd,PrPeLB,PrPeLNB,Rval,...
...
%                   end
            ...
            fprintf(out,'\n'); 
            fprintf(out,'  EL#   itp#       x-coord      y-coord      Pr/Pel\n');
            fprintf(out,'\n');            
            PrPeL1=PrPeL2nd(1:4,:);
            PrPeL2=PrPeL2nd(2:5,:);
            nip=5;
            for i = 1:xn 
               ...
               for p=1:(nip-1)
                  ...
                  % top flage end node
                  SN13 = SN13+NG2(i,:);       
                  fprintf(out,'  %3.0f %5.0f %12.3f %12.3f %12.6f\n',i,p,SN6(1,1),SN6(1,2),PrPeL1(p,i));
                  if isequal(p,4)
                     fprintf(out,'  %3.0f %5.0f %12.3f %12.3f %12.6f\n',i,p+1,SN13(1,1),SN13(1,2),PrPeL2(p,i));
                  end
...
%                   end
            ...
            fprintf(out,'\n'); 
            fprintf(out,'  EL#   itp#       x-coord      y-coord    gamma*Pr/Pel\n');
            fprintf(out,'\n');            
            PrPeL1=PrPeLB(1:4,:);
            PrPeL2=PrPeLB(2:5,:);
            nip=5;
...
%                   end
      ...
      elseif isequal(get(ri_report_edit,'Value'),21)
         if ~isempty(PrPeL)
            %WRITING NODAL INFORMATION
            fprintf(out,'****************************************************************\n');
            fprintf(out,'*       Non-prismatic & mono-symmetric I-girder analysis       *\n');
