function [ANE,gammma,FunewR,EGunew,Qintf,QintfE,Qint1,Qint2,MI] = AnalysisNonBuckling(Massemble,...
   Rval,JNodevalue_i,JNodevalue_j,SNodevalue,RNCc,Nshe1,Nshe2,DUP1,DUP2,LNC,LNC1,LNC2,...
   LUEC,PNC,PNC1,PNC2,BNC,BNC1,BNC2,FEL,nmode,ninc,lambda,...
