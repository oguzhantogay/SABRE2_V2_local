function [BNC]=SABRE2GroundApp(JNodevalue,JNodevalue_i,JNodevalue_j,Massemble,Rval,...
...
if isempty(RNCc)
   ...
   Lnode = round(str2double(get(bgm_type_name,'String')));
   if isempty(get(bgm_type_name,'String'))|| isequal(get(bgm_type_name,'String'),'0')        
      BNC(length(RNCc(:,1)),14)=0;
   else
       
%        ###################################################################
      if isequal(str2double(get(bgm_ux_edit,'String')),0) ...
            && isequal(str2double(get(bgm_uy_edit,'String')),0) ...
            && isequal(str2double(get(bgm_uz_edit,'String')),0) ...
            && isequal(str2double(get(bgm_rx_edit,'String')),0) ...
            && isequal(str2double(get(bgm_ry_edit,'String')),0) ...
            && isequal(str2double(get(bgm_rz_edit,'String')),0) ...
            && isequal(str2double(get(bgm_phix_edit,'String')),0)
         set(bgm_height_edit,'Value',1);
      end
%       set(pt_title_name,'Visible','off')
      BNC(length(RNCc(:,1)),14)=0;
      BNC(Lnode,1) =  Lnode;
      BNC(Lnode,2) = str2double(get(bgm_coordx_edit,'String'));
      BNC(Lnode,3) = str2double(get(bgm_coordy_edit,'String'));
      BNC(Lnode,4) = str2double(get(bgm_coordz_edit,'String'));
      BNC(Lnode,5)=str2double(get(bgm_ux_edit,'String'));
      BNC(Lnode,6)=str2double(get(bgm_uy_edit,'String'));
      BNC(Lnode,7)=str2double(get(bgm_uz_edit,'String'));
      BNC(Lnode,8)=str2double(get(bgm_rx_edit,'String'));
      BNC(Lnode,9)=str2double(get(bgm_ry_edit,'String'));
      BNC(Lnode,10)=str2double(get(bgm_rz_edit,'String'));
      BNC(Lnode,11)=str2double(get(bgm_phix_edit,'String'));
      BNC(Lnode,12)=0;
      BNC(Lnode,13)=get(bgm_height_edit,'Value'); 
