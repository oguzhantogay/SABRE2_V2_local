function [AE,gammma,FunewR,EGunew,Qintf,QintfE,Qint1,Qint2,MI,PrPeLB] = AlanysisBuckling(Massemble,...
...
nel = 1; E = zeros(xn,1); G = zeros(xn,1); Fy = zeros(xn,1);
stRho = zeros(xn,1); fillet=zeros(xn,1);
