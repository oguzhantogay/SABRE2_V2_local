function SABRE2ANonBucFun(pn_panel,pt_title_name,fim_infor_name,pd_type_subpanel,pdn_type_text,...
...
set(ri_tau_diagram,'String','   None |   gamma*Pr/Pel ') 
set(ri_report_edit,'String','   None |   Axial |   Shear Y |   Shear Z |   Torque |   Moment Y |   Moment Z |   Bioment |   gamma*Pr/Pel ')
