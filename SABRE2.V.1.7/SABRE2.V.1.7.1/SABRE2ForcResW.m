function [LNC,LNC1,LNC2]=SABRE2ForcResW(JNodevalue,Massemble,Rval,...
   RNCc,DUP1,DUP2,LNC,LNC1,LNC2,LUEC,Nshe1,Nshe2,Bhe1,Bhe2,The1,The2,SGhe1,SGhe2,Mhe1,Mhe2,Bhg,Thg,CSg,Mhg,lfm_type_name,...
   ...
   lfm_height_edit,pt_title_name,LabType,axesm,vstm)
% Developed by Woo Yong Jeong.
% Date : 07/01/2013.
% ************************************************************************
% *****************           Force Loading           ********************
% ************************************************************************
LNC=zeros(length(RNCc(:,1)),14);
LNC1=zeros(length(DUP1(:,1)),14);
LNC2=zeros(length(DUP2(:,1)),14);
