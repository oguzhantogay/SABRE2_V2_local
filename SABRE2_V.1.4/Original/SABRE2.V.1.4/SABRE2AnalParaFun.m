function AnalP=SABRE2AnalParaFun(pn_panel,pt_title_name,fim_infor_name,pd_type_subpanel,pdn_type_text,...
...
% *** sub panel1
set(ap_type_text,'Visible','on')
% *** sub panel2
set([ap_sw_subpanel,ap_sw_text,ap_sw_buttongroup,ap_sw_on_radiobutton,ap_sw_off_radiobutton],'Visible','on');
% *** sub panel3
set([ap_jval_subpanel,ap_jval_text,ap_jval_buttongroup,ap_jval_on_radiobutton,ap_jval_off_radiobutton],'Visible','on');
% *** sub panel4
set([ap_AISC_subpanel,ap_AISC_text,ap_AISC_buttongroup,ap_AISC_on_radiobutton,ap_AISC_off_radiobutton],'Visible','on');
% *** sub panel5
set([ap_bracket_subpanel,ap_bracket_text,ap_cv_buttongroup,ap_cv_on_radiobutton,ap_cv_off_radiobutton],'Visible','on');
set([ap_jeong_text,ap_brent_text,ap_jeong_edit,ap_brent_edit],'Visible','on');
% *** sub panel6
set([ap_1st_subpanel,ap_1st_text,api_assign_text,apninc_assign_text,api_assign_edit,apninc_assign_edit],'Visible','on');
% *** sub panel7
set([ap_2nd_subpanel,ap_2nd_text,ap_da_text,ap_da_buttongroup,ap_da_on_radiobutton,ap_da_off_radiobutton],'Visible','on');
% *** sub panel8
set([ap_mode_subpanel,ap_mode_text,ap_mode_edit],'Visible','on');
set(apninc_mode_edit,'Visible','off');
% *** sub panel9
set([ap_apply_subpanel,ap_apply],'Visible','on');
