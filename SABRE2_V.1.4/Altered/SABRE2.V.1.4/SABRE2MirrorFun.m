function SABRE2MirrorFun(pn_panel,pt_title_name,fim_infor_name,pd_type_subpanel,pdn_type_text,...
...
set(pdn_type_text,'Visible','on')
set(pdn_type_name,'Visible','off')
% *** sub panel2
...
set([pdmi_name,pdmix_edit,pdmiy_edit,pdmiz_edit,pdmi_text,pdmi_type_edit,pdmi_apply],'Visible','on'); 
...
if strcmp(get(gco,'type'),'line')
   if strcmp(sscanf(get(gco,'Tag'),'%[jn]'),'jn')
      ...
      set(gco,'Color','g')      
      set(pdmi_name,'String',num2str(njnode));
      set(pdmix_edit,'String',num2str(JNodevalue(njnode,2)));
      set(pdmiy_edit,'String',num2str(JNodevalue(njnode,3)));
      set(pdmiz_edit,'String',num2str(JNodevalue(njnode,4)));        
   end
end  
