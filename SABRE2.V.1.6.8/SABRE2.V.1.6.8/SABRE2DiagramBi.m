function SABRE2DiagramBi(JNodevalue,Massemble,JNodevalue_i,JNodevalue_j,...
...
Qa=max(max(abs(Qintf(:,7))),max(abs(Qintf(:,14))));
% ------------------------------------------------------------------------
...
for i = 1:xn 
   ...
   case 1
      if isequal(Qa,0)
         ...
         SN2=[MemLength1(i,1) (0) (zg1(i,1)+0)];
         % top flage start node
         SN6=[MemLength1(i,1) (Qintf(i,7)*xa/Qa) (zg1(i,1)+0)];
         % bottom flage end node
         SN9=[MemLength2(i,1) (0) (zg2(i,1)+0)];
         % top flage end node
         SN13=[MemLength2(i,1) (-Qintf(i,14)*xa/Qa) (zg2(i,1)+0)];
      end    
      % *************************** Global Rotation
      SN2=Rz*SN2';SN2=SN2';
      SN6=Rz*SN6';SN6=SN6'; 
   ...
   oweb = surf(axesm,Xwweb,Zwweb,Ywweb,'FaceColor',[0.8 0.8 0.8],...
      'EdgeColor',[0 0 0.8],'Tag','DBi'); hold on 
   elseif isequal(strcmp(get(vstm,'Checked'),'on'),0) % black background 
   oweb = surf(axesm,Xwweb,Zwweb,Ywweb,'FaceColor',[0.8 0.8 0.8],...
      'EdgeColor','c','Tag','DBi'); hold on        
   end
   ...
   if isequal(strcmp(get(vstm,'Checked'),'on'),1) % white background
      if isequal(mod(i,2),0)
         text(SN6(1,1),-SN6(1,3),SN6(1,2),num2str(Qintf(i,7)),'FontSize',9,...
            'Fontweight','bold','Tag','DiagramBi','VerticalAlignment','top','HorizontalAlignment','right','Color','k','PickableParts','none');
         text(SN13(1,1),-SN13(1,3),SN13(1,2),num2str(-Qintf(i,14)),'FontSize',9,...
            'Fontweight','bold','Tag','DiagramBi','VerticalAlignment','bottom','HorizontalAlignment','left','Color','k','PickableParts','none');   
      else
         text(SN6(1,1),-SN6(1,3),SN6(1,2),num2str(Qintf(i,7)),'FontSize',9,...
            'Fontweight','bold','Tag','DiagramBi','VerticalAlignment','top','HorizontalAlignment','right','Color','k','PickableParts','none');
         text(SN13(1,1),-SN13(1,3),SN13(1,2),num2str(-Qintf(i,14)),'FontSize',9,...
   ...
   elseif isequal(strcmp(get(vstm,'Checked'),'on'),0) % black background
      if isequal(mod(i,2),0)
         text(SN6(1,1),-SN6(1,3),SN6(1,2),num2str(Qintf(i,7)),'FontSize',9,...
            'Fontweight','bold','Tag','DiagramBi','VerticalAlignment','top','HorizontalAlignment','right','Color','w','PickableParts','none');
         text(SN13(1,1),-SN13(1,3),SN13(1,2),num2str(-Qintf(i,14)),'FontSize',9,...
            'Fontweight','bold','Tag','DiagramBi','VerticalAlignment','bottom','HorizontalAlignment','left','Color','w','PickableParts','none');   
      else
         text(SN6(1,1),-SN6(1,3),SN6(1,2),num2str(Qintf(i,7)),'FontSize',9,...
            'Fontweight','bold','Tag','DiagramBi','VerticalAlignment','top','HorizontalAlignment','right','Color','w','PickableParts','none');
         text(SN13(1,1),-SN13(1,3),SN13(1,2),num2str(-Qintf(i,14)),'FontSize',9,...
   ...
   if isequal(strcmp(get(vstm,'Checked'),'on'),1) % white background
   plot3(axesm,Evalue(:,1),-Evalue(:,3),Evalue(:,2),'Color',[0.4 0.4 0.4],'Tag',['Bi',num2str(i)]);
   hold on;
   elseif isequal(strcmp(get(vstm,'Checked'),'on'),0) % black background
   plot3(axesm,Evalue(:,1),-Evalue(:,3),Evalue(:,2),'Color','y','Tag',['Bi',num2str(i)]);
   hold on;       
   end
   Evalue = [];
