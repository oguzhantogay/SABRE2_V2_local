function SABRE2OpenFun(pn_panel,pt_title_name,fim_infor_name,pd_type_subpanel,pdn_type_text,...
...
% ************************************************************************
% Node Reset Edit        
set(pdn_type_name,'String','1');
set([pdn_coordx_edit,pdn_coordy_edit,pdn_coordz_edit],'String','0'); 
% Member Reset Edit
set(pde_type_name,'string','1');
...
% set(pamen_assign_edit,'string','8');
...
% Force Reset Edit
set([lfm_type_name,lfm_coordx_edit],'String','')
set([lfm_coordy_edit,lfm_coordz_edit],'String','')
set([lfm_fx_edit,lfm_fy_edit,lfm_fz_edit],'String','0')
set([lfm_mx_edit,lfm_my_edit,lfm_mz_edit],'String','0')
% Distributed Load Reset Edit
set([lum_type_mem,lum_type_seg],'String','');       
set([lum_wx_edit,lum_wy_edit,lum_wz_edit],'string','0');
% Boundary Conditions Reset Edit
set([bfm_type_name,bfm_coordx_edit],'String','')
set([bfm_coordy_edit,bfm_coordz_edit],'String','')
set([bfm_ux_edit,bfm_uy_edit,bfm_uz_edit],'String','0')
set([bfm_rx_edit,bfm_ry_edit,bfm_rz_edit],'String','0')
