function [AI,gammma,FunewR,EGunew,Qintf,QintfE,Qint1,Qint2,MI,tau,Rpg,Rpc,Rpt,Rh,Myc,Myt,My,Jval,Phi_Mmax,Phi_Py,UC,PrPeL,crLTB,LGv] = AlanysisIEBuckling(Massemble,...
...
pn=0; nn=0; Fflag=0; Sflag=0; gammap=[]; gamman=[];gamp=[]; gamn=[]; PrPeL=zeros(5,xn);
